...
static xmlScalarEncode xmlEncodeUTF8 (xmlUTF32 scalar, xmlUChar *dst,
                                      xmlSize len);

static xmlScalarDecode xmlDecodeUTF8 (xmlUChar *src, xmlSize len);

xmlEncodingConverter utf8Converter
    = { .encode = xmlEncodeUTF8, .decode = xmlDecodeUTF8 };
