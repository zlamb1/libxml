...
typedef enum xmlWhitespacePolicy
{
...
typedef enum xmlStringInterningPolicy
{
...
typedef struct xmlParserAttributes
{
...
xmlError xmlInitParser (xmlParserAttributes *attribs, xmlParser **parser);

xmlError xmlDestroyParser (xmlParser *parser);
